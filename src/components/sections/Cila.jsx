  ...
  return (
    <Section id={id} title="CILA" icon={Armchair}>
      <article className="space-y-2">
        ...
        L'articolo 6-bis disciplina invece le attività di edilizia libera soggette
         ...
         gli interventi di manutenzione straordinaria, che non riguardino le parti
          strutturali e le modifiche ai prospetti e cioè le opere e le modifiche necessarie
           per rinnovare e sostituire parti degli edifici;
             
            
         frazionamento o accorpamento delle unità immobiliari con esecuzione di opere;
             
            
         gli interventi di restauro e risanamento conservativo che non interessino parti strutturali.
