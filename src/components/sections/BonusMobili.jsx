  ...
  return (
    <Section id={id} title="Bonus Mobili" icon={Armchair}>
      <article className="space-y-2">
        ...
        <p>Il Bonus Mobili è un’agevolazione che consente di portare in detrazione fiscale il 50% della spesa sostenuta per l’acquisto di mobili e grandi elettrodomestici.</p>
<p>La Legge di Bilancio 2025 ha prorogato il Bonus Mobili fino al 31 dicembre 2025.</p>
      <p>L’agevolazione è subordinata agli interventi, anche realizzati in economia, di:</p> 
