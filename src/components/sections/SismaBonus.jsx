  ...
  return (
    <Section id={id} title="Sisma Bonus" icon={Waves}>
      <article className="space-y-2">
        ...
        Nel panorama normativo del 2025, il Sismabonus si conferma uno strumento strategico per interventi antisismici, evolvendosi in un’ottica di resilienza integrata. Oltre alle detrazioni fiscali fino all’85% (in base alla classe di rischio raggiunta), oggi il bonus include:</p>
