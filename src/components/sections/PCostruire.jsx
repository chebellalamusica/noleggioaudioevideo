...
export default function PCostruire ({ id }) {
  return (
    <Section id={id} title="Permesso di Costruire" icon={CircleDot}>
...
<ul className="text-[17px] text-[#5F5F5F] list-disc space-y-3 pl-8 animate-wave delay-150">        
  <li>gli interventi di nuova costruzione;  </li>   
 <li>gli interventi di ristrutturazione urbanistica;  </li>   
 <li>gli interventi di ristrutturazione edilizia che portino ad un organismo in tutto o in parte diverso dal precedente, con modifiche della volumetria complessiva degli edifici;  </li>   
 <li>cambi d'uso in zone omogenee A;</li>     
 <li>modifiche della sagoma o della volumetria degli edifici.  </li>   
